...
const addressCascaderOptions = []
getProvince(addressData, addressCascaderOptions)
function getProvince(addressData, receiverOptions){
  for(let index in addressData){
    let children = []
    ...
    receiverOptions.push(params)
  }
}

function getCity(cityArray, receiverCityArray){
  for(let indexC in cityArray){
    let city = cityArray[indexC].name
    ...
    receiverCityArray.push(params)
  }
}
function getArea(areaArray, receiverAreaArray){
